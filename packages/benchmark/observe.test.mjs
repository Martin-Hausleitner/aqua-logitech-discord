...
test('serializes only passive public state fields', () => {
  ...
  assert.deepEqual(line, { observerDate: 1, observerMonoNs: '2', observerSeq: 3, stateSeq: 9, appStateSeq: undefined, recording: true, source: 'watch', degraded: false, intent: undefined, confirmation: undefined, discord: { muted: false, online: true, stateSeq: 4, clientMonoMs: 12 } });
